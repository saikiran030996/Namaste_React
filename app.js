...
const RestaurantCard = (props) => {
    ...
    const {cloudinaryImageId,name,avgRating,cuisines,deliveryTime,costForTwoString,} = resData?.data
    return (
        <div className='res-card' style={styleCard}>
            <img 
            className="res-logo" alt = "res-logo" src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/" + cloudinaryImageId}/>
            <h3>{name}</h3>
            <h4>{cuisines.join(", ")}</h4>
